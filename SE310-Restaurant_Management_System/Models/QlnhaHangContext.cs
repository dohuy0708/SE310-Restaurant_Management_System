...
public partial class QlnhaHangContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-TE90HW\\SQLEXPRESS;Initial Catalog=QLNhaHang;Integrated Security=True;Encrypt=False;Trust Server Certificate=True");
